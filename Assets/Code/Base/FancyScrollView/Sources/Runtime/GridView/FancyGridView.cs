...
namespace FancyScrollView
{
        ...
        where TContext : class, IFancyGridViewContext, new()
    {
        ...
        /// デフォルトのセルグループクラス.
        /// </summary>
        public abstract class DefaultCellGroup : FancyCellGroup<TItemData, TContext> { }

        /// <summary>
        /// 最初にセルを配置する軸方向のセル同士の余白.
        /// </summary>
        [SerializeField] protected float startAxisSpacing = 16f;
        ...
        /// セルのサイズ.
        /// </summary>
        [SerializeField] protected Vector2 cellSize = new(128f, 128f);
