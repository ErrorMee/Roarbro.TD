Shader "SDF/UI/Ascii01"
{
        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            float4 endWithLight(v2f f, float sd)
            {
                float4 light = endWithOutGlow(float4(1, 1, 1, f.color.a), sd, f);
                float4 cover = endSimple(f.color, sd + 0.05, f);
                float4 end = blendColor(cover, light);
                return end;
            }
            ...
            half4 frag(v2f f) : SV_Target
            {
                ...
                if (id == 43)//+
                {
                    ...
                    return endWithOutLine(f.color, sd, f);
                }
