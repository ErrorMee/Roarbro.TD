...
//https://github.com/spawn66336/UnityUI/blob/master/UnityEditor.UI/UI/MenuOptions.cs#L159
public static class UIMenuUtil
{
    public const string kUILayerName = "UI";

    public static Vector2 s_ImageGUIElementSize = new Vector2(128f, 128f);
    ...
    public static GameObject CreateUIElementRoot<T>(MenuCommand menuCommand) where T : MaskableGraphic
    {
        GameObject go = CreateUIElementRoot(typeof(T).Name, menuCommand, s_ImageGUIElementSize);
        go.AddComponent<T>();
        return go;
    }
